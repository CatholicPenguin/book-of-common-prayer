...
\begin{figure}[H]
    \centering
    \includegraphics[width=103mm, height=138.450mm]{PeterPaulJohn.eps}
\end{figure}
\clearpage
%Front Matter
\frontmatter
...
\include{pages/Front/Foreword}
\include{pages/Front/EditorsPreface}
\cleardoublepage
\include{pages/Front/Rubrics}
\include{pages/Front/OrderPsalms}
\include{pages/Front/TableYear}
\include{pages/Front/Ranking}
\include{pages/Front/Kalendar}
%Lectionary
\cleardoublepage
\include{pages/Lectionary/LectionaryCover}
\include{pages/Lectionary/Lectionary}
\include{pages/Lectionary/LectionaryFestivals}
\include{pages/Lectionary/LectionaryAdditional}
\include{pages/Lectionary/LectionaryCommon}
\include{pages/Lectionary/AlternativePsalter}
%\include{pages/Lectionary/DevotionalPsalms}
%Daily Office
\cleardoublepage
\include{pages/Office/DailyOfficeCover}
\include{pages/Office/ForeOffice}
\include{pages/Office/Mattins}
\include{pages/Office/OTCant}
\include{pages/Office/Prime}
\include{pages/Office/Pretiosa}
\include{pages/Office/CommemorationDeparted}
\include{pages/Office/Athanasian}
\include{pages/Office/Terce}
\include{pages/Office/Sext}
\include{pages/Office/None}
\include{pages/Office/Evensong}
\include{pages/Office/Compline}
\include{pages/Office/Mary}
%Prayers \& Thanksgivings
\cleardoublepage
\include{pages/Prayers/PrayersCover}
\include{pages/Prayers/PrayersThanksgivings}
%Litanies \& Offices
\cleardoublepage
\include{pages/Litanies/LitaniesCover}
\include{pages/Litanies/GreatLitany}
\include{pages/Litanies/Penitential}
\include{pages/Litanies/LitanySaints}
\include{pages/Litanies/BaptismalBlessing}
%Office of the Dead
\cleardoublepage
\include{pages/OfficeDead/OfficeDeadCover}
\include{pages/OfficeDead/VesperDead}
\include{pages/OfficeDead/MatinsDead}
\include{pages/OfficeDead/LaudsDead}
%Eucharistic Devotions
\cleardoublepage
\include{pages/Eucharistic/EucharisticCover}
\include{pages/Eucharistic/Benediction}
\include{pages/Eucharistic/Preparation}
\include{pages/Eucharistic/Thanksgiving}
\include{pages/Eucharistic/Asperges}
\include{pages/Eucharistic/ForeMass}
%Holy Mass
\cleardoublepage
\include{pages/HolyMass/MassCover}
\include{pages/HolyMass/Mass}
\include{pages/HolyMass/PreCommunionHymn}
\include{pages/HolyMass/Prefaces}
...
%Easter Even
\cleardoublepage
\include{pages/Propers/EasterEvenCover.tex}
...
%Pastoral Rites
\cleardoublepage
\include{pages/Pastoral/PastoralCover}
\include{pages/Pastoral/Baptism}
\include{pages/Pastoral/AdultBaptism}
\include{pages/Pastoral/Confession}
\include{pages/Pastoral/Reception}
\include{pages/Pastoral/Confirmation}
\include{pages/Pastoral/Matrimony}
\include{pages/Pastoral/Purification}
\include{pages/Pastoral/Unction}
\include{pages/Pastoral/CommunionOfTheSick}
\include{pages/Pastoral/Burial}
\include{pages/Pastoral/BurialChild}
%Family Prayers
\cleardoublepage
