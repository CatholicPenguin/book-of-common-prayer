...
\begin{secrubric}
    To be used for Catechumens who are not to be received by Baptism (conditional excepted), immediately before the Sacrament of Confirmation.
\end{secrubric}
\begin{secrubric}
...
\end{secrubric}
\subsection{Veni, Creator Spiritus}
...
\begin{rubric}
    The Priest then sits, and the new convert kneels before him: who, touching the Holy Gospel with his right hand, utters the Profession of Faith as stated below; or, if he know not how to read, the Priest recites the same profession to him slowly, so that he can understand it when he turns and pronounce it with the priest in distinct words.
\end{rubric}
...
The Catholic doctrine of the Incarnation, Passion, Death, and Resurrection of our Lord Jesus Christ; and the personal union of the two Natures, the divine and the human: the Divine Maternity of the most holy Mary together with her most spotless virginity; %Immaculate Conception removed.
...
\begin{rubric}
    The new convert then says Psalm 51, as follows (or Psalm 130).
\end{rubric}
...
\lett{O}{God,} whose nature and property is ever to have mercy and to forgive: receive our humble petitions, so that this thy \textit{servant}---being bound by the sentence of excommunication---may be loosed by the pitifulness of thy great mercy. \textit{Amen.}
...
\lett{W}{ith} Apostolic Authority, I, by such authority, absolve thee from the bond of excommunication, which thou hadst incurred,\margrubleft{1}{In grave or light doubt as to whether the penitent incurred excommunication by the profession of heresy, the priest here inserts the word `perchance'.} and I restore thee to the Sacred Sacraments of the Church, Communion, and the Unity of the Faithful, in the Name of the Father, and of the Son, {\ding{64}} and of the Holy Ghost. Amen.
...
\lett{T}{he} Blessing of Almighty God, the Father, {\ding{64}} the Son, and the Holy Ghost, descend upon you and remain with you always. \textit{Amen.}
