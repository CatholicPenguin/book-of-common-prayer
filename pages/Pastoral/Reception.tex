...
\begin{rubric}
    The new convert then says Psalm 51 as follows (or, Psalm 130), ending in the \blackrubric{Gloria Patri,}
\end{rubric}
...
\lett{W}{ith} Apostolic Authority, I, by such authority, absolve thee from the bond of excommunication, which thou hadst incurred,\margrub{1}{In grave or light doubt as to whether the penitent incurred excommunication by the profession of heresy, the priest here inserts the word `perchance'.} and I restore thee to the Sacred Sacraments of the Church, Communion, and the Unity of the Faithful, in the Name of the Father, and of the Son, {\ding{64}} and of the Holy Ghost. Amen.
