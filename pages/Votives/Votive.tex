...
\begin{rubric}
    The Collects \blackrubric{of St. Mary in Advent} (p. \pageref{SPMaryInAdvent}), \blackrubric{of the Advent Feria,} and \blackrubric{of the Holy Ghost} (p. \pageref{SPHolyGhost}) are here said.
\end{rubric}
...
\begin{rubric}
    The Secrets \blackrubric{of St. Mary in Advent} (p. \pageref{SPMaryInAdvent}), \blackrubric{of the Advent Feria,} and \blackrubric{of the Holy Ghost} (p. \pageref{SPHolyGhost}) are here said.
\end{rubric}
...
\begin{rubric}
    The Postcommunions \blackrubric{of St. Mary in Advent} (p. \pageref{SPMaryInAdvent}), \blackrubric{of the Advent Feria,} and \blackrubric{of the Holy Ghost} (p. \pageref{SPHolyGhost}) are here said.
\end{rubric}
...
\subsection{Epistle. {\itshape Revelation 5:11}}
...
\subsection{Epistle. {\itshape John 1:47}}
...
\subsection{Epistle. {\itshape Ephesians 5:20}}
...
\subsection{Gospel. {\itshape Matthew 19:4}}
