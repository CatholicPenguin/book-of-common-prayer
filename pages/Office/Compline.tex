...
\subsubsection{Te lucis ante terminum.}
\begin{inhead}
	Ferial Days
\end{inhead}
...
\subsubsection{Salvator mundi Domine.}
...
\subsubsection{Christe qui lux est et dies.}
...
\par
5. Yea, our Defender, be thou night\par
...
\subsubsection{Jesu Salvator s{\ae}culi.}

\begin{inhead}
	Eastertide
\end{inhead}
\lett{J}{esu,} who brought'st redemption night,\par
