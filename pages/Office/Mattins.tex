...
\begin{rubric}
    Then shall be said or sung the following Psalm; except on those days for which an Anthem is appointed.
\end{rubric}

\begin{rubric}
    But \textsc{Note}, That on Good Friday the \blackrubric{Venite} is omitted, and it may be omitted on Ash Wednesday.
\end{rubric}
...
\par\noindent
\begin{rubric}
    On \blackrubric{Easter Sunday,} \blackrubric{Low Sunday,} \blackrubric{Whitsunday,} and any Red Letter Day; Verses 8-11 of the \blackrubric{Venite} may be replaced with the following.
\end{rubric}
