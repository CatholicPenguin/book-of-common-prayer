...
\begin{rubric}
    \textsc{But Note}, That on Good Friday the \blackrubric{Venite} is omitted, and it may be omitted on Ash Wednesday.
\end{rubric}
...
The following Hymn is sung or said on all Sundays (outside Advent, Septuagesimatide, \& Lent) and Feast Days (Semidouble or higher). %This rubric brings the Te Deum to the same standard as the other Festal canticles and brings it closer to Breviary \& Sarum use.
\end{rubric}
\begin{rubric}
...
\begin{rubric}
The \blackrubric{Benedicite} is prayed on all Sundays in Advent, Septuagesimatide, \& Lent; and on Days below Semidouble, such as Memorials and Vigils.
\end{rubric}
\begin{rubric}
