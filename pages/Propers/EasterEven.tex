...
\phantomsection
\addcontentsline{toc}{section}{Easter Even}

\subsection{Blessing of the Paschal Fire}
...
\subsection{Procession of the Light of Christ}
\fancyhead[RO,LE]{\textit{Lumen Christi}}
...
\subsection{Blessing of the Baptismal Font}\label{EasterFontBlessing}
...
\subsection{Paschal Litany}\label{PaschalLitany}
...
\begin{rubric}
	After the receiving of the Sacraments, Vespers begins in the choir.
\end{rubric}

\subsubsection{Psalm 117. \textit{Laudate Dominum}}
...
\begin{rubric}
	And the Priest, having said \blackrubric{Let this my bounden duty,} gives the Blessing and concludes in the usual manner.
\end{rubric}
