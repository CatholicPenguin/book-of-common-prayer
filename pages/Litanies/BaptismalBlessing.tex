...
\begin{secrubric}
    ...
    \textsc{Note,} The Priest may instead say the shorter Litany from Holy Saturday in the St. Botolph's Missal.
\end{secrubric}
\begin{secrubric}
%FIND TRANSLATION:
...
\end{secrubric}
\begin{secrubric}
    After the final \blackrubric{Kyrie, eléison,} the Priest says the Lord's Prayer (as noted) and the Apostles' Creed, all in a clear voice. He then proceeds with the following.
\end{secrubric}
...
{\lett{O}{misericors} Deus, Pater Domini et Servatoris nostri Jesu Christi, qui creasti Elementum aquae ad regenerationem fidelium populorum, super quo in Jordane Baptisato descendit Spiritus Sanctus in specie columb{\ae}. Emitte qu{\ae}sumus eundem Spiritum, ut nobis adsit, et nostram invocationem factam in nomine suo exaudiar, Sanctifica {\ding{64}} hunc fontem Baptismi, tu qui omnia sanctificas, ut omnes hic baptisati potentia verbi tui regenerentur Spiritu Sancto, et fiant filii adoptionis {\ae}tern{\ae}. \textit{Amen.}\\

Misericors Deus, concede ut vetus Adam in his, qui in hoc lavacro baptisantur, sepeliatur, ut novus homo inde resurgat. Amen.

Tribue ut carnales concupiscenti{\ae} mortificentur in illis, et omnes affectus Spiritus vivant et augeantur. Amen.

Pr{\ae}sta etiam, ut omnes qui ad hoc lavacrum abrenuntiant diabolo, et ipsius operibus accipiant robur et fortitudinem, ut illium vincant, et de carne et mundo triumphent. Amen.

Quicunqu{\ae} te confessus fuerit, hunc tu agnosce in regno tuo. Amen.

Concede, ut omnia peccata et vitia hoc fonte sic extinguantur, ut nunquam postea regnent in servis tuis. Amen.

Tribue, ut qui semel gregi tuo fuerit insertus, perpetuo in eo permaneant. Amen.

Pr{\ae}sta, ut omnes qui in hac vita propter te semetipsos abne gant, te inveniant et lucrentur, qui es infinitus, et in{\ae}stimabilis thesaurus. Amen.

Annue ut omnes, qui nostro ministerio hic tibi dicantur, imbuantur c{\oe}lestibus donis, et ornentur {\ae}ternis pr{\ae}miis, gratia et misercordia tua, qui vivis et regnas Deus, per infinita s{\ae}cula. Amen.\\
...
\lett{O}{mnipotens} {\ae}ternae Deus, cujus unigenitus Filius Dominus noster Jesus Christus effudit pretiosum suum sanguinem et aquam in remissionem peccatorum nostrorum, et pr{\ae}cepit discipulis suis, ut irent in mundum universum, et doceret omnes gentes, ac baptisarent eas in nomine Patris, et Filii, et Spiritus Sancti, fave qu{\ae}sumus supplicationibus Ecclesi{\ae} tu{\ae}, et pr{\ae}sta ut omnes servi tui, qui in hoc fonte pr{\ae}parato ad Sacramenti administrationem lavantur, repleantur omni gratia spirituali, et semper permaneant in numero fidelium et electorum tuorum, per Dominum nostrum Jesum Christum. \textit{Amen.}
}
